				...
				<div class="panel-body">
					<form method="post" action="" class="form">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="najomca_idnajomca" placeholder="Vložte IDnájomcu" value="<?php echo !empty($post['najomca_idnajomca'])?$post['najomca_idnajomca']:''; ?>">
							<?php echo form_error('najomca_idnajomca','<p class="help-block text-danger">','</p>'); ?>
						</div>
						<div class="form-group">
							<label for="title">Kontakt</label>
							<input type="text" class="form-control" name="Kontakt_idKontakt" placeholder="Vložte IDkontaktu" value="<?php echo !empty($post['Kontakt_idKontakt'])?$post['Kontakt_idKontakt']:''; ?>">
